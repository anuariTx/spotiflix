...
function* fetchService(id: string) {
  const accessToken =
    'BQDlbs4Pp9CGH_siOLnzgBqrRI_2IyjGxyjOiPkey7e0-guWZ_E48oWOi4ziZOw5DOjb3VIBj3pl5Ec1RM5VG5YhkLAEee-YJ6YZjfpMb2bcD6Fi10ePvHibfwdAycT8YkrGi_wVpREFbdtDEFF_7wu7tA';
  const headers = {
